...
const BY_MESSAGE: [RegExp, string][] = [
  ...
  [/new password should be different|same as the (old|previous)/i,
    "지금 쓰는 비밀번호와 다른 비밀번호를 입력해 주세요."],
  [/otp.*expired/i, "인증번호가 만료되었습니다. 다시 받아 주세요."],
  [/otp.*invalid|invalid otp/i, "인증번호가 올바르지 않습니다."],
  [/token has expired|email link is invalid|expired/i, "만료되었습니다. 다시 받아 주세요."],
  [/invalid token/i, "인증번호가 올바르지 않습니다."],
